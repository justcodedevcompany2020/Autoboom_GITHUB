       ...
       <View style={styles.mainWrapper}>
           ...
           <View style={styles.scrollViewWrapper}>
               <ScrollView horizontal={true} style={styles.scrollView}>
                   ...
                   >
                       <Text style={[styles.menuTopButtonText,styles.menuTopButtonTextActive ]}>Самые быстрые</Text>
                   ...
                   <TouchableOpacity
                       ...
                       style={styles.menuTopButton}
                   >
                       <Text style={[styles.menuTopButtonText ]}>Большие джипы</Text>
                   ...
                   <TouchableOpacity
                       ...
                       style={styles.menuTopButton}
                   >
                       <Text style={[styles.menuTopButtonText ]}>Семейные</Text>
           ...
           <View style={styles.showMoreButtonWrapper}>
               <TouchableOpacity style={styles.showMoreButton}>
                   <Text style={styles.showMoreButtonText}>Показать все модели категории</Text>
               </TouchableOpacity>
