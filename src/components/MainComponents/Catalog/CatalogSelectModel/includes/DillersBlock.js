...
export default function App(props) {
    ...
    return (
        <View style={styles.dillersTop}>
            ...
            <Text style={styles.dillersTopTitle}>
                Дилеры Ауди
            </Text>
            ...
            <View style={styles.dillersTopButtonWrapper}>
                ...
                <TouchableOpacity
                    ...
                    style={styles.dillersTopButton}
                >
                    <Text style={[styles.dillersTopButtonText, last_search_active_button == 0 && styles.dillersTopButtonTextActive ]}>Автосалоны</Text>

                    {last_search_active_button == 0 && <View style={styles.dillersTopButtonActiveLine}></View>}
                ...
                <TouchableOpacity
                    ...
                    style={styles.dillersTopButton}
                >
                    <Text style={[styles.dillersTopButtonText, last_search_active_button == 1 && styles.dillersTopButtonTextActive]}>Автосервисы</Text>

                    {last_search_active_button == 1 && <View style={styles.dillersTopButtonActiveLine}></View>}
            ...
            <View style={styles.showMoreButtonWrapper}>
                <TouchableOpacity style={styles.showMoreButton}>
                    <Text style={styles.showMoreButtonText}>Показать все компании</Text>
                </TouchableOpacity>
