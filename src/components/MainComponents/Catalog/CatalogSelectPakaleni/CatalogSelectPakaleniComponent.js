...
import {openPakaleniPopUpInCatalogSelectPakaleniPage} from '../../../../redux/actions/actions';
...
import PakaleniPopup from "./includes/Popups/PakaleniPopup";
import PakaleniList from "./includes/PakaleniList";
...
import ReleaseYears from "./includes/ReleaseYears";
import OnSaleToday from "./includes/OnSaleToday";

export default function App(props)
{
    // Redux
    const {is_open_pakaleni_popup_in_catalog_select_pakaleni_page} = useSelector(state => state.justDriveReducer);
    const dispatch = useDispatch();
    const handleOpenPakaleniPopUpInCatalogSelectPakaleniPage = (to_address_data) => dispatch(openPakaleniPopUpInCatalogSelectPakaleniPage());
    ...
    if(is_open_pakaleni_popup_in_catalog_select_pakaleni_page)
    {
        return (
            <PakaleniPopup navigation={props.navigation}/>
        )
    }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={{width: '100%', flex:1}}>
                ...
                <View style={{width:'100%', paddingHorizontal:16, marginBottom:16}}>
                    <Text style={{fontSize:22, fontWeight:'bold', lineHeight:28}}>Ауди SQ8 Спортбэк e-tron</Text>
                </View>
                ...
                <View style={styles.inputWrapper}>
                    ...
                    <View style={styles.inputWrapperContainer}>
                        ...
                        <TouchableOpacity onPress={() => {handleOpenPakaleniPopUpInCatalogSelectPakaleniPage()}} style={styles.inputWrapperContainer2}>
                            <Text style={[styles.inputWrapperContainer2Text, {color: '#6C7694'}]}>Не выбрано</Text>
                        </TouchableOpacity>
                    </View>
